...
/* THIS FILE:  /home/paslab/CLOC/examples/snack/test_snack/hw.h  */
...
#define __SNK_DEFS
#endif
extern _CPPSTRING_ void cal_diskernel(float* data_ker,float* cent_ker,int* table,const unsigned int K,const unsigned int DIM,const unsigned int DCNT,int* chpt,int* cent_c_ker,float* min_dis, const snk_lparm_t * lparm);
